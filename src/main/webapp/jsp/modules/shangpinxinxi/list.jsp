...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<select name="shangpinxilie" id="shangpinxilieSelect" class="form-control form-control-sm" aria-controls="tableId">
									</select>
	...
	<script>
		...
		function search(){
			...
			var shangpinxilieIndex = document.getElementById("shangpinxilieSelect").selectedIndex;
			var shangpinxilieOptions = document.getElementById("shangpinxilieSelect").options;
			var shangpinxilieSelectedOption = shangpinxilieOptions[shangpinxilieIndex]
			if(shangpinxilieSelectedOption.text != null && shangpinxilieSelectedOption.text != ''){
				searchForm.shangpinxilie = "%" + shangpinxilieSelectedOption.text + "%";
			}
			getDataList();
		}		
		// 获取数据列表

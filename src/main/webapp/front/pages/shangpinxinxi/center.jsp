				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<select name="shangpinxilie" id="shangpinxilie">
									<option value="">请选择</option>
									<option v-for="(item,index) in shangpinxilie" v-bind:key="index" :value="item">{{item}}</option>
								</select>
							</div>
						</div>
                                                                                                <div class="layui-form-item">
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																								...
                																								http.request(`option/shangpinxilie/shangpinxilie`,'get',{},(res)=>{
					vue.shangpinxilie = res.data
				});
																// 上传图片
